...
class TDAmeritrade {
    constructor(config) {
        ...
        this.clientId = (config.apiKey + '').endsWith(constants.API_KEY_SUFFIX) ? config.apiKey : config.apiKey + constants.API_KEY_SUFFIX;
        this.redirectURL = config.redirectURL || defaults.REDIRECT_URL;
        this.accessToken = null;
        this.refreshToken = null;
        this.request = function ({ method=defaults.GET, url, data, params }) {
